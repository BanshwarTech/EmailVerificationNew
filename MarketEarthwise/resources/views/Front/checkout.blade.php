                ...
                <div class="col-12">
                    ...
                    <form id="frmPlaceOrder">
                        ...
                        <div class="user-actions accordion" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div id="checkout_coupon" class="collapse checkout_coupon coupon_code"
                                data-parent="#checkout_coupon" style="margin-top: unset;border:none;">
                                <div class="checkout_info">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="default-form-box">
                                    ...
                                    <input type="text" placeholder=" Name*" id="name" value="{{ $users['name'] }}"
                                        name="name">
                            ...
                            <div class="col-lg-6">
                                <div class="default-form-box">
                                    ...
                                    <input type="text" id="email" value="{{ $users['email'] }}" name="email">
