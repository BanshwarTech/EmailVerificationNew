@if (session('ADMIN_LOGIN') && session('ADMIN_LOGIN') == true)
    ...
    <body>
        ...
        <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                ...
                <div class="layout-page">
                    ...
                    <nav class="col-lg-12 layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                        id="layout-navbar">
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <span
                                                            class="fw-semibold d-block">{{ session('ADMIN_NAME') }}</span>
                                                        <small class="text-muted">{{ session('ADMIN_EMAIL') }}</small>
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
        ...
        <!-- Core JS -->
        <!-- build:js assets/vendor/js/core -->
