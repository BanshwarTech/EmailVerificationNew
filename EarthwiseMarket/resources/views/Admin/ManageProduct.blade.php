                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('product.manage_product_process') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label for="image" class="control-label mb-1"> Image (250px *
                                        300px)</label>
                                    ...
                                    @enderror
                                    @if ($image != '')
                                        <a href="{{ asset('storage/media/' . $image) }}" target="_blank"><img
                                ...
                                <div class="col-md-8">
                                    <label for="model" class="control-label mb-1"> Lead
                                        Time</label>
                                ...
                                <div class="col-md-3">
                                    <label for="model" class="control-label mb-1"> IS Promo
                                    </label>
                                ...
                                <div class="col-md-3">
                                    <label for="model" class="control-label mb-1"> IS Featured
                                    </label>
                                ...
                                <div class="col-md-3">
                                    <label for="model" class="control-label mb-1"> IS Tranding
                                    </label>
                                ...
                                <div class="col-md-3">
                                    <label for="model" class="control-label mb-1"> IS Discounted
                                    </label>
                                    ...
                                    <div class="row" id="product_images_box">
                                        ...
                                        @foreach ($productImagesArr as $key => $val)
                                            ...
                                            <div class="col-md-4 product_images_{{ $loop_count_num++ }}">
                                                <label for="images" class="control-label mb-1"> Image (250px
                                                    * 300px)</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            ...
                                                            <input id="sku" name="sku[]" type="text"
                                                                ...
                                                                aria-invalid="false" value="{{ $pAArr['sku'] }}"
                                                                required>
                                                        </div>
                                                        <div class="col-md-2">
                                                            ...
                                                            <input id="mrp" name="mrp[]" type="text"
                                                                class="form-control" aria-required="true"
                                                                aria-invalid="false" value="{{ $pAArr['mrp'] }}"
                                                                required>
                                                        </div>
                                                        <div class="col-md-2">
                                                            ...
                                                            <input id="price" name="price[]" type="text"
                                                                class="form-control" aria-required="true"
                                                                aria-invalid="false" value="{{ $pAArr['price'] }}"
                                                                required>
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            <label for="color_id" class="control-label mb-1">
                                                                Color</label>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <input id="qty" name="qty[]" type="text"
                                                                class="form-control" aria-required="true"
                                                                aria-invalid="false" value="{{ $pAArr['qty'] }}"
                                                                required>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="attr_image" class="control-label mb-1"> Image
                                                                (250px * 300px)</label>
