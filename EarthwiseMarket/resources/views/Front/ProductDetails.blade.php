                                                ...
                                                @if ($attr->color != '')
                                                    <label
                                                        ...
                                                        <input name="product-color" type="radio"
                                                            onclick="change_product_color_image('{{ asset('storage/media/product_attr/' . $attr->attr_image) }}', '{{ $attr->color }}')">
                                                        <span class="product-color-{{ strtolower($attr->color) }}"
                                                            style="background-color: {{ strtolower($attr->color) }}; width: 30px; height: 30px; display: inline-block; border: 1px solid #ccc;"></span>
                                                    </label>
                                                @endif
                                            @endforeach
                                        </div>
